...
router.post('/advance-payment-success/:transactionId', rental_controller_1.RentalControllers.advancePaymentSuccess);
router.post('/advance-payment-fail/:transactionId', rental_controller_1.RentalControllers.advancePaymentFail);
router.get('/:id', rental_controller_1.RentalControllers.getSingleRental);
