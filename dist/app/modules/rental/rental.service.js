...
const createRentalIntoDb = (payload, decodedInfo, paymentInfo) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      !(paymentInit === null || paymentInit === void 0
        ? void 0
        : paymentInit.url)
    ) {
    ...
    try {
      ...
      const user = yield auth_model_1.UserModel.findOne({ email, role }).select(
        '_id',
      )
      if (!user) {
        throw new AppError_1.AppError(
...
const makeAdvancePaymentSuccess = transactionId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
      yield bike_model_1.BikeModel.findByIdAndUpdate(
        result === null || result === void 0 ? void 0 : result.bikeId,
        {
          isAvailable: false,
        },
      )
...
const makeAdvancePaymentFail = transactionId =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const returnBike = (id, rentalEndTime) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const session = yield mongoose_1.default.startSession()
    try {
      session.startTransaction()
      const rental = yield rental_model_1.RentalModel.findOne({
        _id: id,
      }).select('startTime bikeId')
      if (!rental) {
        throw new AppError_1.AppError(
      ...
      const startTime = new Date(
        `1970-01-01T${rental === null || rental === void 0 ? void 0 : rental.startTime}:00`,
      )
      ...
      const totalCost =
        rentalTimeInHours *
        (bike === null || bike === void 0 ? void 0 : bike.pricePerHour)
      const updateDoc = {
        isReturned: true,
      ...
      yield bike_model_1.BikeModel.findOneAndUpdate(
        { _id: rental.bikeId },
        { isAvailable: true },
        { session },
      )
...
const getAllRentalsFromDb = (decoded, query, myRentals) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (myRentals === 'true') {
      ...
      query.userId =
        userInfo === null || userInfo === void 0 ? void 0 : userInfo._id
    }
    const bikeQuery = new QueryBuilder_1.default(
      rental_model_1.RentalModel.find()
...
const getSingleRentalFromDb = id =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const makePayment = (rentalId, paymentInfo) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (paymentInfo.total_amount < 100) {
      ...
      const result = yield rental_model_1.RentalModel.findByIdAndUpdate(
        rentalId,
        {
          isPaid: true,
        },
      ...
      const paymentInit = yield (0, payment_utils_1.initiatePayment)(
        paymentInfo,
      )
      if (
        !(paymentInit === null || paymentInit === void 0
...
const paymentSuccess = (transactionId, rentalId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield rental_model_1.RentalModel.findByIdAndUpdate(
      rentalId,
      {
...
const paymentFail = transactionId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield rental_model_1.RentalModel.findOneAndUpdate(
      {
        transactionId,
