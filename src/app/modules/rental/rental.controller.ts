...
const advancePaymentSuccess = catchAsync(async (req, res) => {
  ...
  res.redirect(
    `https://bike-rental-reservation-service.vercel.app/dashboard/user/my-rentals?booking=confirmed`,
  )
})
...
const advancePaymentFail = catchAsync(async (req, res) => {
  ...
  res.redirect(
    `https://bike-rental-reservation-service.vercel.app/advance-payment-failure`,
  )
})
...
const paymentSuccess = catchAsync(async (req, res) => {
  ...
  res.redirect(
    `https://bike-rental-reservation-service.vercel.app/payment-success/${transactionId}`,
  )
})
...
const paymentFail = catchAsync(async (req, res) => {
  ...
  res.redirect(
    `https://bike-rental-reservation-service.vercel.app/payment-failure`,
  )
})
